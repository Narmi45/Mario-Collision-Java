...
Name: Imran Khan
Date: 10/8/21
Assignment Description: Implemented a Mario Object into Assignment 3 that can use the arrow keys and space bar to move and jump.
						Used numerous conditional statements, booleans, and loops to create collision detection so the Mario
						Object could collide with the sides of the bricks. Also created a background that would move based on the
						Mario's position. Also used an iterator to createe a linked list that would create bricks.
*/
